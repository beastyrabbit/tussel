...
export default {
  ...
  sources: {
    strudel: {
      code: `setcps(0.75)
stack(s("bd ~ rim sd").bank("crate").mask("1 1 0 1"), s("hh hh hh hh").gain(0.5).late(0.01), note("60 60 63 65").s("saw").lpf(700).release(0.3).slow(2), note("67 65 63 60").s("triangle").gain(0.15).early(0.125))`,
      shape: 'script',
    },
    tidal: {
